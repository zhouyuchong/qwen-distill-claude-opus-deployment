...
合并脚本：整合了 run.sh 的配置和 demo.py 的功能
可以直接运行：python run.py --model_path <path> [其他参数]
"""
import argparse
import torch
...
# 默认配置 (来自 run.sh)
# ==============================================================================
DEFAULT_CONDA_ENV = "/path-to-conda-env/qwen35_opus"
DEFAULT_MODEL_PATH = "/path-to-weight/Qwen3.5-27B-Claude-4.6-Opus-Reasoning-Distilled"
...
def main():
    parser = argparse.ArgumentParser(
        description="Qwen3.5-27B-Claude-4.6-Opus-Reasoning-Distilled Demo",
...
示例:
  ...
  # 单次纯文本对话
  python run.py --prompt "你好，介绍一下你自己"

  # 图片理解
  python run.py --image /path/to/image.jpg --prompt "描述这张图片"
